...
/***********************************************************
 Usage:
 ust like any UIViewController, SwiftWebVC can be pushed into a UINavigationController stack:
...
open class SwiftWebVC: UIViewController {
    ...
    public var mainTitle: String? = nil
    ...
    override open func viewWillAppear(_ animated: Bool) {
        ...
        navBarTitle.font = UIFont.systemFont(ofSize: 17.0, weight: .semibold)
...
extension SwiftWebVC: WKNavigationDelegate {
    ...
    public func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
        ...
        webView.evaluateJavaScript("document.title", completionHandler: {(response, error) in
            if let txt = self.mainTitle {
                self.navBarTitle.text = txt
            } else {
